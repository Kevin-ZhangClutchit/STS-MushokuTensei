...
public class Roxy extends CustomPlayer {
    ...
    private static final String[] ORB_TEXTURES = new String[]{
            "trialModResources/img/UI/orb/layer5.png",
            "trialModResources/img/UI/orb/layer4.png",
            "trialModResources/img/UI/orb/layer3.png",
            "trialModResources/img/UI/orb/layer2.png",
            "trialModResources/img/UI/orb/layer1.png",
            "trialModResources/img/UI/orb/layer6.png",
            "trialModResources/img/UI/orb/layer5d.png",
            "trialModResources/img/UI/orb/layer4d.png",
            "trialModResources/img/UI/orb/layer3d.png",
            "trialModResources/img/UI/orb/layer2d.png",
            "trialModResources/img/UI/orb/layer1d.png"
    };
    // 每个图层的旋转速度
    ...
    public Roxy(String name) {
        ...
        // 如果你的人物没有动画，那么这些不需要写
        // this.loadAnimation("trialModResources/img/char/character.atlas", "trialModResources/img/char/character.json", 1.8F);
    ...
    public Color getCardTrailColor() {
        return MushokuTensei.ROXY_BLUE;
    }
    ...
    public ArrayList<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel("trialModResources/img/char/Victory1.png", "ATTACK_MAGIC_FAST_1"));
        panels.add(new CutscenePanel("trialModResources/img/char/Victory2.png"));
        panels.add(new CutscenePanel("trialModResources/img/char/Victory3.png"));
        return panels;
    }
